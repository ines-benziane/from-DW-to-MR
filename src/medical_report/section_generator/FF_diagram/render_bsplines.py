...
def draw_bands(all_muscles_data, parent, ns) :
...
def generate_svg(svg_file, all_muscles_data):
    ...
    draw_bands(all_muscles_data, parent, ns)
    return tree
